...
[`Action`](/docs/api/@foscia/core/type-aliases/Action) object by calling your
...
[`oneOrCurrent`](/docs/api/@foscia/core/functions/oneOrCurrent) is used to
