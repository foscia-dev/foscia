...
[`headers`](/docs/api/@foscia/http/type-aliases/HttpAdapterConfig#headers)
...
- [`paramsSerializer`](/docs/api/@foscia/http/functions/paramsSerializer)
  (default for [`makeHttpAdapter`](/docs/api/@foscia/http/functions/makeHttpAdapter))
  which serialize a params object using
