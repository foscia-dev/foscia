...
You can generate a new composable using [`@foscia/cli`](/docs/digging-deeper/cli).
...
Composables share the [models' hooks system](/docs/core-concepts/models#hooks).
...
Hook registration function (such as `onCreating`) returned callback will
...
You can generate a new factory using [`@foscia/cli`](/docs/digging-deeper/cli).
...
Models factories share the [models' hooks system](/docs/core-concepts/models#hooks).
