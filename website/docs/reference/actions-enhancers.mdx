...
- [`Model`](/docs/reference/api/modules/foscia_core#model) `query`
the model to query
- [`ModelIdType | undefined`](/docs/reference/api/modules/foscia_core#modelidtype) `id`
the record's ID to query

##### Instance signature

- [`ModelInstance`](/docs/reference/api/modules/foscia_core#modelinstance) `instance`
the instance to query
- [`ModelRelationKey | undefined`](/docs/reference/api/modules/foscia_core#modelrelationkey) `relation`
...
**Deprecated**, will be removed in a next major release.
**[Use `query` with a model instead.](#query)**
...
**Deprecated**, will be removed in a next major release.
**[Use `query` with an instance instead.](#query)**
...
**Deprecated**, will be removed in a next major release.
**[Use `query` with an instance and relation instead.](#query)**
...
**Deprecated**, will be removed in a next major release.
**[Use `query` with an instance or a model and ID instead.](#query)**
...
**Deprecated**, will be removed in a next major release.
**[Use `query` with a model and ID instead.](#query)**
...
- [`ModelRelationKey<M>`](/docs/reference/api/modules/foscia_core#modelrelationkey)
  `relation` a relation to update
- [`ModelInferPropValue<R>`](/docs/reference/api/modules/foscia_core#modelinferpropvalue)
...
- [`ModelRelationKey<M>`](/docs/reference/api/modules/foscia_core#modelrelationkey)
  `relation` a relation to update
- [`ModelInferPropValue<R> | ModelInferPropValue<R>[number]`](/docs/reference/api/modules/foscia_core#modelinferpropvalue)
...
- [`HttpRequestConfig`](/docs/reference/api/modules/foscia_http#httprequestconfig)
  `config` a request configuration object
