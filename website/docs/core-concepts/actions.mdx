...
:::warning Before reading this guide
...
which you should provide an `extension` configuration option. If you are using a
custom action factory, you should check the
