...
This guide is only about how actions work. You can read more about action
factories setups in
[the getting started guide](/docs/getting-started#action-factory).

Using Foscia actions may look different when using one or another
implementation, even if most basic actions are standardized.

If you want to see some concrete examples on how actions could be used, you can
check the [examples documentation section](/docs/category/examples).
...
<Link className="button bg--primary" to="/docs/reference/actions-enhancers">
...
<Link className="button bg--primary" to="/docs/reference/actions-runners">
