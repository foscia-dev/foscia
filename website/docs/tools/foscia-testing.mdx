---
sidebar_position: 20
title: Foscia testing
description: Unit testing your code when using Foscia.
---
...
**Unit testing Foscia is experimental** and may change in a near future.
...
- Mocking an action factory for unit tests
- Writing expectations about actions execution
- Mocking actions results
