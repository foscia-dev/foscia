import renderComposableForDef from '@foscia/cli/templates/concerns/renderComposableForDef';
...
import renderPropertyForDef from '@foscia/cli/templates/concerns/renderPropertyForDef';
