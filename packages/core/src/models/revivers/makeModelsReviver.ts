...
import {
  ...
  ReviverParentsMap,
} from '@foscia/core/models/revivers/types';
import { ModelInstance, ModelLimitedSnapshot, ModelSnapshot } from '@foscia/core/models/oldTypes';
...
export default (config: ModelsReviverConfig) => {
  ...
  const reviveValues = (values: Dictionary<unknown>, parents: ReviverParentsMap) => mapWithKeys(
    values,
