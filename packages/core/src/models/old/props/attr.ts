import makeAttributeFactory from '@foscia/core/models/old/props/utilities/makeAttributeFactory';
import {
...
export default /* @__PURE__ */ makeAttributeFactory(SYMBOL_MODEL_PROP_ATTRIBUTE) as {
  /**
