...
export type ModelId<T = any, R extends boolean = boolean> =
  & ModelValueProp<T, R, typeof SYMBOL_MODEL_PROP_ID>;
...
export type ModelAttribute<T = any, R extends boolean = boolean> =
  & ModelValueProp<T, R, typeof SYMBOL_MODEL_PROP_ATTRIBUTE>;
...
> =
  ...
  & ModelValueProp<T, R, typeof SYMBOL_MODEL_PROP_RELATION>;
