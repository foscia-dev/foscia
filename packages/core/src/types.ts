 ...
 *
 * It will be used by other dependencies, like {@link DeserializerI | `DeserializerI`},
 ...
 * It will also be used by other dependencies, like {@link DeserializerI | `DeserializerI`},
 ...
 */
export type AdapterResponseI<RawData, Data = unknown> = {
  /**
   ...
   * by {@link DeserializerI | `DeserializerI`}.
 ...
 * @typeParam Data Adapter's original response data, containing records or relations data.
 */
export type AdapterI<RawData, Data = any> = {
  /**
 ...
 */
export type SerializerI<Record, Related, Data> = {
  /**
 ...
 */
export type DeserializerI<Data, Deserialized extends DeserializedData = DeserializedData> = {
  /**
